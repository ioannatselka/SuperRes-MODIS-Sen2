...
test_dataset = SingleImageDataset('test', configs, target_sen2_resolution=240)
...
model = load_best_model(model1, checkpoint_dir="/home/itselka/nvme1/itselka/resultsx2/fsrcnn")
...
model = load_best_model(model1, checkpoint_dir="/home/itselka/nvme1/itselka/resultsx2/srcnn")
...
model = load_best_model(model1, checkpoint_dir="/home/itselka/nvme1/itselka/resultsx2/edsr")
...
model = load_best_model(model1, checkpoint_dir="/home/itselka/nvme1/itselka/resultsx2/espcn")
...
model = load_best_model(model1, checkpoint_dir="/home/itselka/nvme1/itselka/resultsx2/mrunet")
...
model = load_best_model(model1, checkpoint_dir="/home/itselka/nvme1/itselka/resultsx2/vdsr")
